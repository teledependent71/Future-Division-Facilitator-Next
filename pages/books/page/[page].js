...
import booksPageInitialPaths8b699Resource from '../../../resources/books-page-initial-paths-8b699'
import booksPageInitialPropsCb6ebResource from '../../../resources/books-page-initial-props-cb6eb'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths8b699Resource({})
...
export async function getStaticProps(context) {
  const response = await booksPageInitialPropsCb6ebResource({
    ...context?.params,
